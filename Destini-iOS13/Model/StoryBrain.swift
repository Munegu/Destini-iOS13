...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice:String) -> Story {
        ...
        return Story(title: stories[storyNumber].title, choice1: stories[storyNumber].choice1, choice1Destination: stories[storyNumber].choice1Destination, choice2: stories[storyNumber].choice2, choice2Destination: stories[storyNumber].choice2Destination)
